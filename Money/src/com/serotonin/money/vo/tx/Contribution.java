...
public class Contribution extends Transaction {
    ...
    public Contribution(final int id, final int accountId, final Date date, final double amount)
            throws TransactionException {
        this(id, accountId, date, new BigDecimal(amount));
    }

    public Contribution(final int id, final int accountId, final Date date, final BigDecimal amount)
            throws TransactionException {
        if (!isGTZero(amount))
